...
def auth_cert(registNo,headt):
    ...
    data={"birthdate":"1998-5-18","civilStatus":"10050001","curp":st+"980518MM"+st+"V8","delegationOrMunicipality":"zxcvbbbccxxx","education":"10190005",
...
def auth_app_grab_data(registNo,custNo,headt):
    ...
    "ipResolveCom":"2409:8162:a46:5405:1:0:107f:acec%20","deviceId":"a2eff92b-86cb-4614-a66c-84ae322f3adcA2:B4:74:63:FB:40LIO-AL00","imei":imei,"mac":"A2:B4:74:63:FB:40","phoneNo":registNo,"recordBehavior":"抓取设备数据","recordTime":"1621332187810","userId":custNo,"mobileBrand":"HUAWEI","mobileModel":"LIO-AL00","systemVersion":"10","otherInfo":""},"custNo":custNo}
    #联系人
