...
appNo='202'    #FR只支持单期无积分和优惠券,25002400
mainInfo={
    '201':['wangs2@whalekun.com','https://test-mgt.lanaplus.mx','26002401','mex_pdl_loan','LanaPlus'],         #GAID                           app版本号
    '202':['wangs@whalekun.com','https://test-mgt.feriarapida.mx','25002400','mex_pdl_loan','FeriaRapida','FC423D8F-BC7E-4430-BD97-66E903FR202','118','10090001']}
which_db=mainInfo[appNo][3]   #数据库库名
prodNo=mainInfo[appNo][2]     #产品编号
host_mgt=mainInfo[appNo][1]   #MGT域名
app_type=mainInfo[appNo][7]
host_api="https://test-api.quantx.mx"        #APP
host_action="https://test-action.quantx.mx"  #埋点
host_pay="https://test-pay.quantx.mx"        #支付
host_coll="https://test-collection.feriarapida.mx"      #催收
head_api={"user-agent": "Dart/2.12 (dart:io)","x-user-language": "es","x-auth-token": "Bearer" ,"accept-encoding": "gzip","content-length": "63","host":"test-api.quantx.mx","x-app-name": mainInfo[appNo][4],"content-type": "application/json","x-app-type": "10090001","x-app-version": mainInfo[appNo][6],"x-app-no": appNo }
