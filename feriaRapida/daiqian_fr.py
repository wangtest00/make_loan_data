...
def auth_cert(registNo,headt):
    ...
    data={"birthdate":"1992-5-18","civilStatus":"10050001","curp":st+"920518MM"+st+"V8","delegationOrMunicipality":"zxcvbbbccxxx","education":"10190005",
...
def bank_auth(custNo,headt):
    ...
    data={"bankCode":"10020037","clabe":"012180015365516420","custNo":custNo}
...
def update_batch_log():
    ...
    else:                                                                         #IS_PROD_SEL必须=10000001，才允许产品匹配
