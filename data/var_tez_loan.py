__all__=['host_api','host_mgt','host_pay','head_pay_f','host_coll','head_api','head_mgt','head_pay','CONFIGS','prodNo','appNo','appName','tez_db','mgt_user','mgt_user_pwd','app_version_no']

tez_db='india_tez_loan'   #目前只支持单期（产品匹配）
prodNo_tez=['10003','301','Zet_Loan','wangs@quantditech.com','jk@123','1.0.0']
prodNo=prodNo_tez[0]
appNo=prodNo_tez[1]
appName=prodNo_tez[2]
mgt_user=prodNo_tez[3]
mgt_user_pwd=prodNo_tez[4]
app_version_no=prodNo_tez[5]
...
head_api={"user-agent": "Dart/2.12 (dart:io)","x-user-language": "es","x-auth-token": "Bearer" ,"accept-encoding": "gzip","content-length": "63",
          ...
          "x-app-type": "10090001","x-app-version": app_version_no,"x-app-no": appNo }
...
CONFIGS = {'india_tez_loan': {'host':'172.21.1.97','port':3306, 'user': 'cs_wangs','password': 'cs_wangs!qw####','database': 'india_tez_loan'}}