...
def stp_repayment(cuentaBeneficiario,monto):
    ...
    r=requests.post("https://test-pay.quantx.mx/api/trade/stp_repayment/annon/event/webhook",data=json.dumps(data),headers=head_pay)
    print(r.json())
...
if __name__ == '__main__':
    #gaishu('L2012106098091145782101319680')
    #stp_payout('L2012106028088353440382885888','w2021060200100960003525181')
    insert_risk('L2012106158093037254018244608')
    #stp_repayment('','622')
