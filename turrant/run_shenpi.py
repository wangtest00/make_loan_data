...
def first_apply_bank(registNo):
    daiQian = DaiQian_Tur()
    sql0 = "select a.LOAN_NO,a.CUST_NO from lo_loan_dtl a  left JOIN cu_cust_reg_dtl b on a.CUST_NO=b.CUST_NO where a.BEFORE_STAT='10260001' and b.REGIST_NO='" + registNo + "';"
    data0 = DataBase(configs).get_one(sql0)
    print(data0)
    loanNo = data0[0]
    custNo = data0[1]
